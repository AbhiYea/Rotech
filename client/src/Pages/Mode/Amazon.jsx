...
export default function Amazon(){
      ...
      const [messages, setMessages] = useState([
        { sender: "bot", text: "Hi 👋! Ready to shop? I can help you find, select, and order items easily on Amazon. What are you looking for today — a gift, groceries, or something else?" },
      ]);
